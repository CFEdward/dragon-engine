...
public class NewProject : ViewModelBase
{
    ...
    private readonly string _templatePath = @"..\..\DragonEditor\ProjectTemplates\";
    ...
    private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\DragonProjects\";
    ...
    public string CreateProject(ProjectTemplate template)
    {
        ...
        try
        {
            ...
            var dirInfo = new DirectoryInfo(path + @".Dragon\");
    ...
    private void CreateMSVCSolution(ProjectTemplate template, string projectPath)
    {
        ...
        var engineAPIPath = Path.Combine(MainWindow.DragonPath, @"Engine\EngineAPI\");
        Debug.Assert(Directory.Exists(engineAPIPath));

        var _0 = ProjectName;
        var _1 = "{" + Guid.NewGuid().ToString().ToUpper() + "}";
        var _2 = engineAPIPath;
        var _3 = MainWindow.DragonPath;
