...
public:
	...
	constexpr d3d12_render_texture(d3d12_render_texture&& o) noexcept
	...
	constexpr ID3D12Resource2* const resource() const { return _texture.resource(); }
...
public:
	...
	constexpr descriptor_handle srv() const { return _texture.srv(); }
	constexpr ID3D12Resource2* const resource() { return _texture.resource(); }
