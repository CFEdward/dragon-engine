...
namespace dragon::graphics::d3d12::d3dx {
...
ID3D12RootSignature* create_root_signature(const D3D12_ROOT_SIGNATURE_DESC2& desc);
...
struct d3d12_root_signature_desc : public D3D12_ROOT_SIGNATURE_DESC2
{
	constexpr explicit d3d12_root_signature_desc(const d3d12_root_parameter* parameters, u32 parameter_count, const D3D12_STATIC_SAMPLER_DESC1* static_samplers = nullptr,
												 u32 sampler_count = 0, D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_DENY_HULL_SHADER_ROOT_ACCESS |
		...
		: D3D12_ROOT_SIGNATURE_DESC2{ parameter_count, parameters, sampler_count, static_samplers, flags }
	{}
